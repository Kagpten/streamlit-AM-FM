...
# input parameter
A_m = st.number_input('Masukan Amplitudo Informasi', min_value=0.1, max_value=10.0, step=0.1, value=1.0)
f_m = st.number_input('Masukan Frekuensi Informasi', min_value=1.0, max_value=100.0, step=1.0, value=5.0)
A_c = st.number_input('Masukan Amplitudo Pembawa', min_value=1.0, max_value=10.0, step=0.1, value=5.0)
f_c = st.number_input('Masukan Frekuensi Pembawa', min_value=1.0, max_value=100.0, step=1.0, value=50.0)
